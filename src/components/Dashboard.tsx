...
import { 
  ...
  Settings as SettingsIcon, ChevronRight, Zap, Calendar, BarChart3, Award, Clock
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50/50 pb-32 font-sans animate-in fade-in duration-500">
      ...
      <div className="fixed bottom-6 left-0 w-full px-6 flex justify-center z-30 pointer-events-none">
        <nav className="bg-white/90 backdrop-blur-lg border border-gray-200 p-1.5 rounded-2xl shadow-2xl flex items-center gap-1 pointer-events-auto w-full max-w-[400px] justify-between">
          <button 
            onClick={onStartQuiz} 
            className="flex-1 flex flex-col items-center justify-center py-2.5 rounded-xl shadow-sm transition-all hover:opacity-80"
            style={{ 
          ...
          <button 
            ...
            className="flex-1 flex flex-col items-center justify-center py-2.5 rounded-xl transition-all hover:bg-gray-100"
            aria-label="Simulado"
          >
            <Clock size={20} className="text-gray-500" />
            <span className="text-[10px] font-bold mt-0.5 text-gray-600">Simulado</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-bold mt-0.5 text-gray-600">Stats</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-bold mt-0.5 text-gray-600">Conquistas</span>
          </button>
        </nav>
      </div>
    </div>
